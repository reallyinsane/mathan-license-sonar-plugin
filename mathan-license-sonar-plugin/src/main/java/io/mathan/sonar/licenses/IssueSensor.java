...
import io.mathan.sonar.licenses.parser.ReportParser;
import io.mathan.sonar.licenses.report.XmlReportFile;
import io.mathan.sonar.licenses.report.XmlReportFileImpl;
...
public class IssueSensor implements org.sonar.api.batch.sensor.Sensor {
  ...
  private static final String SENSOR_NAME = "ML-IssueSensor";
...
//  }
  ...
  private Analysis parseAnalysis(SensorContext context) throws IOException, XPathExpressionException, XPathException {
  ...
  public void execute(SensorContext sensorContext) {
    ...
    profiler.startInfo("Process Licenses report");
    try {
...
//      addIssues(sensorContext, analysis, filter);
    ...
    } catch (XPathExpressionException | XPathException e) {
